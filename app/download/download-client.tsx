...
import { DownloadCheckoutCard } from "@/components/ui/download-pricing-modal";
      ...
      {!isPaid ? (
        ...
        <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
          ...
          <div className="space-y-4 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1 text-xs font-semibold text-emerald-400">
              <CheckCircle2 className="h-3.5 w-3.5" />
              <span>7-Day Free Trial Active · Plugin Ready</span>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="relative space-y-3 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
                ...
                <p className="text-[11px] text-zinc-500">
                  Browse to your computer’s <strong>Downloads</strong> folder
                  and select{" "}
                  <code className="text-zinc-300">v6_render.rbz</code>.
                </p>
              </div>
              ...
              <div className="relative space-y-3 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
                ...
                <p className="text-xs leading-relaxed text-zinc-400">
                  The <strong>V6 Render</strong> toolbar will instantly appear
                  in SketchUp.
                </p>
            ...
            <div className="grid gap-4 text-xs text-zinc-400 sm:grid-cols-2">
              ...
              <div className="space-y-1.5 rounded-xl border border-zinc-800/60 bg-zinc-950/60 p-3.5">
                ...
                <p className="leading-relaxed">
                  ...
                  <code className="text-zinc-300">.rbz</code> before installing
                  in SketchUp.
                </p>
              </div>
              ...
              <div className="space-y-1.5 rounded-xl border border-zinc-800/60 bg-zinc-950/60 p-3.5">
                ...
                <p className="leading-relaxed">
                  Yes! V6 Render is 100% universal and runs natively on both
                  Apple Silicon and Intel Macs, as well as Windows 10 &amp; 11.
                </p>
              </div>
              ...
              <div className="space-y-1.5 rounded-xl border border-zinc-800/60 bg-zinc-950/60 p-3.5">
                ...
                <p className="leading-relaxed">
                  Reply directly to your welcome email or reach our 24/7
                  technical team at{" "}
                  <a
                    href="mailto:support@avada.space"
