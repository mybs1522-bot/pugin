    ...
    <section className="w-full py-12 md:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-6">
          {/* CARD 1: 100% Customizable (2 cols on LG) */}
          <Card className="group relative col-span-1 flex flex-col justify-center overflow-hidden border-zinc-800/80 bg-zinc-950/70 p-6 backdrop-blur-md transition-all hover:border-zinc-700 md:col-span-1 lg:col-span-2">
            <CardContent className="flex flex-col items-center justify-center p-0 text-center">
              <div className="relative my-4 flex h-24 w-56 items-center justify-center">
                <svg
                  className="absolute inset-0 h-full w-full text-zinc-700/60"
                  viewBox="0 0 254 104"
                  fill="none"
                ...
                <span className="relative z-10 text-4xl font-bold tracking-tight text-white sm:text-5xl">
                  100%
                </span>
              </div>
          ...
          {/* CARD 2: Secure by default (2 cols on LG) */}
          <Card className="group relative col-span-1 overflow-hidden border-zinc-800/80 bg-zinc-950/70 p-6 backdrop-blur-md transition-all hover:border-zinc-700 md:col-span-1 lg:col-span-2">
            <CardContent className="flex flex-col items-center p-0 text-center">
              <div className="relative mx-auto flex h-24 w-24 items-center justify-center rounded-full border border-white/10 bg-zinc-900/40 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                <svg
                  className="m-auto h-fit w-16"
                  viewBox="0 0 212 143"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          {/* CARD 3: Faster than light (2 cols on LG, 2 cols on MD) */}
          <Card className="group relative col-span-1 overflow-hidden border-zinc-800/80 bg-zinc-950/70 p-6 backdrop-blur-md transition-all hover:border-zinc-700 md:col-span-2 lg:col-span-2">
            <CardContent className="flex flex-col items-center p-0 text-center">
          ...
          {/* CARD 4: Shield with waveform (3 cols on LG, 1 col on MD) */}
          <Card className="group relative col-span-1 overflow-hidden border-zinc-800/80 bg-zinc-950/70 p-6 backdrop-blur-md transition-all hover:border-zinc-700 md:col-span-1 lg:col-span-3">
            <CardContent className="grid h-full grid-cols-1 items-center gap-6 p-0 sm:grid-cols-2">
              <div className="flex flex-col justify-between space-y-4">
                <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-zinc-900/50 before:absolute before:-inset-1.5 before:rounded-full before:border before:border-white/5">
              ...
              <div className="relative -mr-6 -mb-6 rounded-tl-xl border-t border-l border-zinc-800/80 bg-zinc-900/30 p-4">
          ...
          {/* CARD 5: Keep your loved ones safe (3 cols on LG, 1 col on MD) */}
          <Card className="group relative col-span-1 overflow-hidden border-zinc-800/80 bg-zinc-950/70 p-6 backdrop-blur-md transition-all hover:border-zinc-700 md:col-span-1 lg:col-span-3">
            <CardContent className="grid h-full grid-cols-1 items-center gap-6 p-0 sm:grid-cols-2">
              <div className="flex flex-col justify-between space-y-4">
                <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-zinc-900/50 before:absolute before:-inset-1.5 before:rounded-full before:border before:border-white/5">
                  <Users className="h-5 w-5 text-zinc-300" strokeWidth={1.5} />
                </div>
                <div className="space-y-1.5">
                  <h3 className="text-lg font-bold text-white">
              ...
              <div className="relative flex flex-col justify-center space-y-3.5 py-2 sm:-my-4 sm:-mr-4">
                <div className="flex items-center justify-end gap-2.5">
                  <span className="rounded-md border border-zinc-800 bg-zinc-900/90 px-2.5 py-1 font-mono text-[11px] text-zinc-300 shadow-sm">
                    Likeur
                  </span>
                  <div className="h-8 w-8 overflow-hidden rounded-full ring-2 ring-zinc-800">
                    <img
                ...
                <div className="flex items-center justify-start gap-2.5">
                  <div className="h-9 w-9 overflow-hidden rounded-full ring-2 ring-cyan-500/40">
                    <img
                      className="h-full w-full object-cover"
